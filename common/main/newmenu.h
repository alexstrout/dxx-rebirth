...
struct newmenu_layout
{
	struct adjusted_citem
	{
		...
		static adjusted_citem create(std::ranges::subrange<newmenu_item *> items, int citem);
	};
	int             x,y,w,h;
...
int newmenu_do2(menu_title title, menu_subtitle subtitle, std::ranges::subrange<newmenu_item *> items, newmenu_subfunction subfunction, void *userdata, int citem, menu_filename filename);
...
template <typename T>
int newmenu_do2(const menu_title title, const menu_subtitle subtitle, std::ranges::subrange<newmenu_item *> items, const newmenu_subfunction_t<T> subfunction, T *const userdata, const int citem = 0, const menu_filename filename = {})
{
...
template <typename T>
int newmenu_do2(const menu_title title, const menu_subtitle subtitle, std::ranges::subrange<newmenu_item *> items, const newmenu_subfunction_t<const T> subfunction, const T *const userdata, const int citem = 0, const menu_filename filename = {})
{
